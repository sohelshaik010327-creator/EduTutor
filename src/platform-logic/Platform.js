...
// =========================================================
// EDU TUTOR LEARNING ANALYTICS
// =========================================================

const EDU_TUTOR_ANALYTICS_KEY =
...
const recordAnalyticsEvent = (
    ...
    try {
        ...
        console.debug(
            ...
            "EduTutor analytics storage error:",
...
class Platform extends React.Component {
    ...
    constructor(
        ...
        // Add each Q Matrix skill model
        // attribute to each step.

        for (
            const problem
            of this.problemIndex.problems
        ) {
    ...
    componentDidMount() {
        ...
        if (
            ...
            console.log(
                "calling selectLesson from componentDidMount..."
            );
    ...
    getProgressBarData() {
        ...
        const problems =
            this.problemIndex.problems.filter(

                ({ lesson }) =>
                    String(lesson).includes(
                        this.lesson.topics
                    )
    ...
    async selectLesson(
        ...
        if (!this._isMounted) {
            ...
            console.debug(
                "component not mounted, returning early (1)"
            );
        ...
        if (!this._isMounted) {
            ...
            console.debug(
                "component not mounted, returning early (2)"
            );
    ...
    _nextProblem = (
        ...
        if (
            ...
            console.debug(
                "no problems were chosen"
            );


            if (
                this.lesson &&
                !this.lesson.allowRecycle
            ) {
        ...
        if (chosenProblem) {
            ...
            console.debug(
                "still no chosen problem..? must be an error"
            );
        ...
        async (
            ...
            recordAnalyticsEvent(
...

                {
                    ...
                    courseName:
                        this.state.currProblem?.courseName ||
                        null,
                    ...
                    problemMastery:
                        Number.isFinite(
                            this.state.currProblem?.probMastery
                        )
                            ? this.state.currProblem.probMastery
                            : null,
            ...
            if (
                ...
                if (
                    ...
                    console.debug(
                        "updateCanvas called because lesson is complete"
                    );
