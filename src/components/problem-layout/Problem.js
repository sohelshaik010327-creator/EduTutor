...
class Problem extends React.Component {
    ...
    constructor(props, context) {
        ...
        const giveStuFeedback =
            this.props.lesson?.giveStuFeedback;

        const giveStuHints =
            this.props.lesson?.giveStuHints;

        const keepMCOrder =
            this.props.lesson?.keepMCOrder;

        const giveHintOnIncorrect =
            this.props.lesson?.giveHintOnIncorrect;

        const keyboardType =
            this.props.lesson?.keyboardType;

        const doMasteryUpdate =
            this.props.lesson?.doMasteryUpdate;

        const unlockFirstHint =
            this.props.lesson?.unlockFirstHint;

        const giveStuBottomHint =
            this.props.lesson?.giveStuBottomHint;


        this.giveHintOnIncorrect =
            giveHintOnIncorrect != null &&
            giveHintOnIncorrect;

        this.giveStuFeedback =
            giveStuFeedback == null ||
            giveStuFeedback;
        ...
        this.doMasteryUpdate =
            doMasteryUpdate == null ||
            doMasteryUpdate;

        this.unlockFirstHint =
            unlockFirstHint != null &&
            unlockFirstHint;

        this.giveStuBottomHint =
            giveStuBottomHint == null ||
            giveStuBottomHint;

        this.giveDynamicHint =
            this.props.lesson?.allowDynamicHint;
        ...
        try {
            ...
            const event = {
                ...
                lessonId:
                    ...
                    this.props.problem?.lesson ||
                    null,

                courseName:
                    this.props.problem?.courseName ||
                    this.props.lesson?.courseName ||
                    null,
            ...
            console.error(
                "Unable to record EduTutor analytics event:",
                error
            );
    ...
    recordAnswer = (
        ...
        this.recordAnalyticsEvent(
...

            {
                ...
                mastery:
                    masteryData.masteryScore,

                kcMastery:
                    masteryData.kcMastery
    ...
    recordProblemCompleted = () => {
        ...
        if (
            this._analyticsProblemCompleted
        ) {
    ...
    componentDidMount() {
        ...
        /*
         * Record the beginning of the problem.
         */
        this.recordProblemStarted();


        /*
         * query selects all katex annotation
         * and adds aria label attribute to it.
         */
        for (
            const annotation of
    ...
    updateCanvas = async (
        ...
        if (this.context.jwt) {
            ...
            console.debug(
                "updating canvas with problem score"
            );
            ...
            if (
                ...
                toast.error(
                    ...
                    {
                        toastId:
                            ToastID.submit_grade_unknown_error.toString(),
                    }
                ...
                if (
                        ...
                        case 403:
                            ...
                            toast.error(
...

                                {
                                    ...
                                    toastId:
                                        ToastID.not_authorized.toString(),
                    ...
                    console.debug(
                        "successfully submitted grade to Canvas"
                    );
    ...
    answerMade = (
        ...
        console.debug(
            `answer made and is correct: ${isCorrect}`
        );


        /*
         * Existing protection against processing
         * the same step more than once.
         */
        if (
            stepStates[cardIndex] ===
            true
        ) {
        ...
        /*
         * Record correctness for evaluation.
         *
         * This does NOT change BKT.
         */
        this.recordAnswer(
            cardIndex,
            isCorrect
        ...
        if (
            ...
            for (
                ...
                if (
                    ...
                    /*
                     * Record the updated mastery.
                     */
                    this.recordMasteryUpdate(
                        _kcArray
                    );
    ...
    /**
     * Computes the current BKT mastery for logging.
     * Reads the live (in-place mutated) bktParams,
     * so call this AFTER answerMade has applied the
     * update for the step to capture the post-step mastery.
     *
     * @param {string[]} kcArray knowledge components
    ...
    clickNextProblem = async () => {
        ...
        await this.props.problemComplete(
            this.context
        );
    ...
    submitFeedback = () => {
        ...
        console.debug(
            "problem when submitting feedback",
            problem
        );
    ...
    _getNextDebug = (
        ...
        return (
            ...
            this.context.problemIDs[
                ...
                this.context.problemIDs.indexOf(
                    this.props.problem.id
                ) +
                offset
    ...
    getOerLicense = () => {
        ...
        try {
            ...
            if (
                problem.license != null &&
                problem.license.includes(
                    " "
                )
            ) {

                licenseArray =
                    problem.license.split(
                        " <"
                    );
        ...
        licenseName =
            licenseArray[1].substring(
                0,
                licenseArray[1].length - 1
            );
